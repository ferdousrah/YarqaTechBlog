      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        <div className="max-w-2xl mx-auto px-4 py-8">
          ...
          <motion.div
            ...
            className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 mb-6 border border-gray-100 dark:border-gray-700"
          >
          ...
          <motion.div
            ...
            className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border-2 border-red-100 dark:border-red-900"
          >
            <h3 className="font-semibold text-red-600 dark:text-red-500 mb-2">Danger Zone</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
              Once you delete your account, there is no going back. Please be certain.
            </p>
            <button
              onClick={() => setShowDeleteModal(true)}
              className="flex items-center gap-2 px-4 py-2.5 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-500 rounded-lg hover:bg-red-100 dark:hover:bg-red-900/30 transition-colors font-medium text-sm"
            >
            ...
            >
              {deleteStep === 'survey' ? (
                <>
                  ...
                  <div className="p-6 border-b border-gray-100 dark:border-gray-700">
                    <div className="flex items-center justify-between">
                      <div>
                        <h2 className="text-xl font-bold text-gray-900 dark:text-white">We're sorry to see you go</h2>
                        <p className="text-gray-600 dark:text-gray-400 mt-1 text-sm">Help us improve by sharing your feedback</p>
                      </div>
                      <button
                        onClick={resetModal}
                    ...
                    {selectedReason && (
                      ...
                      >
                        ...
                        <textarea
                          ...
                          rows={3}
                          className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none resize-none text-sm bg-white dark:bg-gray-900 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
                        />
                      </motion.div>
                    )}
                  </div>
                  ...
                  <div className="p-6 border-t border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 flex justify-between">
                    <button
                      ...
                      className="px-4 py-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white font-medium text-sm"
                    >
                      Skip
                    </button>
                    <button
                ...
                <>
                  ...
                  <div className="p-6">
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                      To confirm, please type <span className="font-bold text-red-600 dark:text-red-500">DELETE</span> below:
                    </p>
                    <input
                      type="text"
                      value={confirmText}
                      ...
                      className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent outline-none text-sm bg-white dark:bg-gray-900 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
                    />
                  </div>
